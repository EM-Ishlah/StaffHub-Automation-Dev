...
WebUI.verifyElementVisible(findTestObject('Object Repository/Dashboard Page Objects/span_Appointment Overview'))

WebUI.click(findTestObject('Object Repository/Dashboard Page Objects/span_Appointment Overview'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Dashboard Page Objects/span_Branch'))
