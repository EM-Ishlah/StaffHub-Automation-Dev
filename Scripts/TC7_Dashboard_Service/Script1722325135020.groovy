...
WebUI.verifyElementVisible(findTestObject('Object Repository/Dashboard Page Objects/span_Service'))

WebUI.click(findTestObject('Object Repository/Dashboard Page Objects/span_Service'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Dashboard Page Objects/span_New Service'), FailureHandling.STOP_ON_FAILURE)
