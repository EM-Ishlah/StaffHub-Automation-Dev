...
WebUI.verifyElementVisible(findTestObject('Object Repository/Dashboard Page Objects/span_Visit Overview'))

WebUI.click(findTestObject('Object Repository/Dashboard Page Objects/span_Visit Overview'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Dashboard Page Objects/span_New Visit'))
