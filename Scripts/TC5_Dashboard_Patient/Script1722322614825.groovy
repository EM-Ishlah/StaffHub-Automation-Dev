...
WebUI.verifyElementVisible(findTestObject('Object Repository/Dashboard Page Objects/span_Patient'))

WebUI.click(findTestObject('Object Repository/Dashboard Page Objects/span_Patient'))

WebUI.verifyElementText(findTestObject('Object Repository/Dashboard Page Objects/div_List Of Patient'), 'List Of Patient')
